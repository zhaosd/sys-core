package top.zhaosd.core.config;

import top.zhaosd.core.interceptor.LogInterceptor;
import top.zhaosd.core.interceptor.TokenInterceptor;
...
public class WebAppConfigurer extends WebMvcConfigurationSupport {
	...
	@Value("${sys.accessLog.enabled}")	// 是否启用数据库级别系统访问日志功能
	private Boolean enabledAccesslog;
